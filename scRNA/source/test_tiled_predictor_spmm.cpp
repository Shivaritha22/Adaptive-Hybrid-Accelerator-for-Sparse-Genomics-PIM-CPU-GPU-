...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // Step 4: Save result
        // ============================================================
        string y_output_path = "../dataset/Y/y" + postfix + "_check.h5";
        save_Y_h5(Y_final, Y_rows, Y_cols, y_output_path);
        
        // ============================================================
        // Step 5: Compare with baseline and permspmm (silently)
        // ============================================================
        ...
        if (Y_rows != y_baseline_rows || Y_cols != y_baseline_cols) {
            cerr << "Dimension mismatch with baseline" << endl;
            return 1;
        }
        
        string y_permspmm_path = "../dataset/Y/y" + postfix + "_permspmm.h5";
        int y_permspmm_rows, y_permspmm_cols;
        vector<float> Y_permspmm = load_Y_h5(y_permspmm_path, y_permspmm_rows, y_permspmm_cols);
        
        if (Y_rows != y_permspmm_rows || Y_cols != y_permspmm_cols) {
            cerr << "Dimension mismatch with permspmm" << endl;
            return 1;
        }
